    ...
    <div class="container">
        ...
        <form class="form-horizontal" method="POST" action="update_member.php" enctype="multipart/form-data">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="email" id="inputPassword" name="email" value="<?php echo $row['email']; ?>" placeholder="email" required>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                <input type="text" id="inputPassword" name="username"  value="<?php echo $row['username_mem']; ?>" placeholder="Username" required>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inputPassword">Password:</label>
                <div class="controls">
                <input type="text" id="inputPassword" name="password"  value="<?php echo $row['pass_mem']; ?>" placeholder="Password" required>
                </div>
            </div>
