...
<?php
$query=mysqli_query($link,"select * from students where student_id='$session_id'")or die(mysqli_error($link));
    ...
    <div class="container">
		<div class="margin-top">
			...
			<?php
						...
						mysqli_query($link,"update students set password = '$np' where student_id = '$session_id' ")or die(mysqli_error($link)); ?>
