...
<?php include('navbar.php'); ?>
	...
	<td>OPEN:</td>
	<td><?php echo htmlspecialchars('8:00 a.m. to 5:00 p.m.'); ?></td>
	</tr>
	<tr>
	<td></td>
	<td>BREAK:</td>
	<td><?php echo htmlspecialchars('1:00 p.m. to 2:00 p.m.'); ?></td>
	</tr>
	</tbody>
	</table>
	...
	<tr>
	<td><?php echo htmlspecialchars('A.Mursyid<br />Librarian'); ?></td>
	</tr>
